...
public class DStore3 {
    ...
    private static void receiveStore(PrintWriter printWriter, String fileName, int fileSize) {
        try {
    ...
    private static void receiveFileContent(PrintWriter printWriter, InputStream inputStream, int fileSize, boolean storeAckFlag) {
        try {
    ...
    private static void load(String fileName, OutputStream out){
        try {
    ...
    private static void removeFile(PrintWriter printWriter, String fileName){
        File file = new File(file_folder + File.separator + fileName);
        if(file.exists()) {
            if(file.delete()) {
    ...
    private static void listFiles(PrintWriter printWriter){
        String files = "";
    ...
    private static void handleRebalance(PrintWriter controllerPW, String rebalanceInfo){
    ...
    private static void sendFile(Integer port, String fileName){
        try {
    ...
    private static void sendFileContent(OutputStream out){
    ...
    private static void removeFileRebalance(String fileName){
    ...
    public static void setFile_folder(String file_folder) {
        DStore3.file_folder = file_folder;
    }
}